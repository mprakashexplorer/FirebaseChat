...
//                            reference = FirebaseDatabase.getInstance().getReference("Users").child(userid);
                            ...
                            reference = FirebaseDatabase.getInstance("https://lftchat-e4292-default-rtdb.firebaseio.com/").getReference().child(userid);
//                            FirebaseDatabase database = FirebaseDatabase.getInstance("https://lftchat-e4292-default-rtdb.firebaseio.com/").getReference().child(userid);
